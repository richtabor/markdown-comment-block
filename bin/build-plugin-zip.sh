...
zip -r ./dist/markdown-comment-block.zip \
	block.json \
        markdown-comment-block.php \
        license.txt \
	$build_files \
	readme.txt

# Reset `markdown-comment.php`.
git checkout markdown-comment-block.php

# Unzip plugin zip file
unzip ./dist/markdown-comment-block.zip -d "./dist/markdown-comment-block/"
